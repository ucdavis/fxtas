...
- Renamed package from “fxtas” to “rSuStaIn” to reflect its general
  applicability
- Updated all package references, documentation, and URLs
- The package was originally developed for FXTAS research but has been
  generalized for broader use with the SuStaIn algorithm

### Manuscript

- Moved manuscript to `analyses/`
  ([\#69](https://github.com/ucd-iddrc/rSuStaIn/issues/69))
- Tons of polishing
  ([\#63](https://github.com/ucd-iddrc/rSuStaIn/issues/63),
  [\#64](https://github.com/ucd-iddrc/rSuStaIn/issues/64),
  [\#65](https://github.com/ucd-iddrc/rSuStaIn/issues/65))
- Added
...
- removed individual parkinsonian features from OS model
  ([\#106](https://github.com/ucd-iddrc/rSuStaIn/issues/106))
- added info about displayed statistics to rows for
  ...
  ([\#56](https://github.com/ucd-iddrc/rSuStaIn/issues/56))
...
- added red reference line at 3 obs per stage in
  ...
  ([\#91](https://github.com/ucd-iddrc/rSuStaIn/issues/91))
- added grayscale legend to PVDs
  ([\#83](https://github.com/ucd-iddrc/rSuStaIn/issues/83))
- added test for
  [`pvd_lineplot()`](https:/UCD-IDDRC.github.io/rSuStaIn/preview/pr154/reference/pvd_lineplot.md)
  ([\#68](https://github.com/ucd-iddrc/rSuStaIn/issues/68))
- added `biomarker_order` argument to
  [`compact_pvd_data_prep()`](https:/UCD-IDDRC.github.io/rSuStaIn/preview/pr154/reference/compact_pvd_data_prep.md)
...
- added tools for finding journals to submit to
  ([\#66](https://github.com/ucd-iddrc/rSuStaIn/issues/66))
...
- moved `analyses/` into `inst`
  ([\#120](https://github.com/ucd-iddrc/rSuStaIn/issues/120))
...
- configured .lintr
  ([\#74](https://github.com/ucd-iddrc/rSuStaIn/issues/74))
