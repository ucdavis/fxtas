...
The goal of `rSuStaIn` is to provide an R implementation of the Ordinal
SuStaIn algorithm (Young et al. (2021)) for studying disease progression
through subtype and stage inference.

This package was originally developed to study progression in fragile
...
tremor/ataxia syndrome revealed by subtype and stage inference”. It has
been generalized as rSuStaIn to allow application to other diseases and
datasets.
