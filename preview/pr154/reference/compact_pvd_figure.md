...
#> Registered S3 methods overwritten by 'fxtas':
#>   method                    from    
#>   autoplot.PF               rSuStaIn
#>   autoplot.permutation_test rSuStaIn
#>   labels.list               rSuStaIn
#>   pander.prob_correct       rSuStaIn
#>   print.permutation_test    rSuStaIn
#>   summary.permutation_test  rSuStaIn
#>   var_label.list            rSuStaIn
# facet labels
